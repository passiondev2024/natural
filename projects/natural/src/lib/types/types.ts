 ...
 */
export type ExtractTone<P> =
    P extends NaturalAbstractModelService<infer Tone, any, any, any, any, any, any, any, any, any> ? Tone : never;

/**
 * Extract the Vone type from a NaturalAbstractModelService
 */
export type ExtractVone<P> =
    P extends NaturalAbstractModelService<any, infer Vone, any, any, any, any, any, any, any, any>
 ...
 */
export type ExtractTall<P> =
    P extends NaturalAbstractModelService<any, any, infer Tall, any, any, any, any, any, any, any>
 ...
 */
export type ExtractVall<P> =
    P extends NaturalAbstractModelService<any, any, any, infer Vall, any, any, any, any, any, any>
 ...
 */
export type ExtractTcreate<P> =
    P extends NaturalAbstractModelService<any, any, any, any, infer Tcreate, any, any, any, any, any> ? Tcreate : never;

/**
 * Extract the Vcreate type from a NaturalAbstractModelService
 */
export type ExtractVcreate<P> =
    P extends NaturalAbstractModelService<any, any, any, any, any, infer Vcreate, any, any, any, any>
 ...
 */
export type ExtractTupdate<P> =
    P extends NaturalAbstractModelService<any, any, any, any, any, any, infer Tupdate, any, any, any> ? Tupdate : never;

/**
 * Extract the Vupdate type from a NaturalAbstractModelService
 */
export type ExtractVupdate<P> =
    P extends NaturalAbstractModelService<any, any, any, any, any, any, any, infer Vupdate, any, any>
 ...
 */
export type ExtractTdelete<P> =
    P extends NaturalAbstractModelService<any, any, any, any, any, any, any, any, infer Tdelete, any> ? Tdelete : never;

/**
 * Extract the Vdelete type from a NaturalAbstractModelService
 */
export type ExtractVdelete<P> =
    P extends NaturalAbstractModelService<any, any, any, any, any, any, any, any, any, infer Vdelete>
