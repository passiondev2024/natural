...
export type NaturalDialogTriggerRedirectionValues =
...
export class NaturalDialogTriggerComponent implements OnDestroy {
    ...
    constructor(
        ...
        this.dialogRef.beforeClosed().subscribe((exitValue: NaturalDialogTriggerRedirectionValues) => this.redirect(exitValue));
    }
