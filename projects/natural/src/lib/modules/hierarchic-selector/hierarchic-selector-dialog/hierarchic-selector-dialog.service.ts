...
export class NaturalHierarchicSelectorDialogService {
    ...
    public open(hierarchicConfig: HierarchicDialogConfig,
                dialogConfig?: MatDialogConfig): MatDialogRef<NaturalHierarchicSelectorDialogComponent, HierarchicDialogResult> {
        ...
        return this.dialog.open<NaturalHierarchicSelectorDialogComponent, any, HierarchicDialogResult>(
