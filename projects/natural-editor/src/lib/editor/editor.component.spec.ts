...
describe('NaturalEditorComponent', () => {
        ...
        it('should follow advanced schema rules', done => {
            ...
            setTimeout(() => {
                expect(getProsemirrorContent(fixture)).toBe(
                    '<h1>h1</h1><h2>h1</h2><h3>h3</h3><h4>h4</h4><h5>h5</h5><h6>h6</h6><pre><code>code</code></pre><p>p"foo</p><p><strong>strong</strong></p><p><em>em</em></p><p><a href="a" title="a">a</a></p><div class="tableWrapper"><table style="min-width: 25px;"><colgroup><col></colgroup><tbody><tr><td><p>table</p></td></tr></tbody></table></div><p><img src="some url" alt="foo" contenteditable="false" draggable="true"><img class="ProseMirror-separator"><br class="ProseMirror-trailingBreak"></p><ul><li><p>ul</p></li></ul><ol><li><p>ol</p></li></ol><blockquote><p>blockquote</p></blockquote>',
                );
                done();
            });
        });
    ...
    describe('with basic schema', () => {
        ...
        it('should follow basic schema rules', done => {
            ...
            setTimeout(() => {
                expect(getProsemirrorContent(fixture)).toBe(
                    '<h1>h1</h1><h2>h1</h2><h3>h3</h3><h4>h4</h4><h5>h5</h5><h6>h6</h6><h1>code</h1><p>p"foo</p><p><strong>strong</strong></p><p><em>em</em></p><p><a href="a" title="a">a</a></p><p>table</p><p><br class="ProseMirror-trailingBreak"></p><ul><li><p>ul</p></li></ul><ol><li><p>ol</p></li></ol><p>blockquote</p>',
                );
                done();
            });
        });
